...
export const EN: Readonly<Record<string, string>> = {
  ...
  "前进": "Forward",
  "网址": "Address",
  "localhost:8888 或工作目录里的 .html": "localhost:8888, or a .html in the working folder",
  "上面输一个本机地址，或者点消息里的链接。": "Type a local address above, or click a link in the conversation.",
  "审阅": "Review",
